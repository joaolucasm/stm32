...
#define ADE9000_MASK0_WFB_TRIG_IRQ			0x00010000					/*MASK0 apenas com o bit de WFB_TRIG_IRQ habilitado*/

#define ADE9000_DSP_FS_DECIMAL 				74532013.0
#define ADE9000_PIN_FS_VOLTAGE				1.0
...
//
//================================================================================================================================================
//void ADE9000_Main_WFB();
//void ADE9000_Get_Real_Values(int32_t raw32, int word_in_sample);
...
int32_t remount_value(uint16_t raw_word_index);
