...
#define ADE9000_MASK0 						0x00010000		/*Habilita interrupcao de WFB_TRIG_IRQ*/
#define ADE9000_MASK1						0x000001C0		/*Habilita interrupcao de ZXTOVA, ZXTOVB e ZXTOVC*/
...
#define ADE9000_EGY_TIME 					0x1F3F 			/*Acumula 1 amostras, 1/8000 segundo de acumula��o*/
...
#define ADE9000_WFB_CFG_CONFIGURATION 		0x13E0			/*Modo burst da waveform habilitada em todos os canais, captura desabilitada, fixed data rate data, continuous fill(11), Waveforms Processed by the DSP source, IN enable*/
#define ADE9000_WFB_CFG_STOP 				0x13E0			/*Mesma coisa que o configuration, apenas para poder resetar a captura de dados do WFB*/
