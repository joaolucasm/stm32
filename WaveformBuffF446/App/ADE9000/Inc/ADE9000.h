...
#define ADE9000_WFB_CFG_CONFIGURATION 		0x13E0			/*Modo burst da waveform habilitada em todos os canais, captura desabilitada, fixed data rate data, continuous filling(10), Waveforms Processed by the DSP source, IN disable*/
