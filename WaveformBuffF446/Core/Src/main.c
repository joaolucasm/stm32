...
const osThreadAttr_t enernetTask_attributes = {
  .name = "enernetTask",
  .stack_size = 128 * 4,
...
// Implemenação das funções para o STM32 do Display (uart diferente do console)
uint8_t uartRxByte;
...
/* USER CODE BEGIN Header_StartEnernetTask */
/**
  * @brief  Function implementing the enernetTask thread.
...
/**
* @brief Function implementing the uartTransmitTas thread.
* @param argument: Not used
* @retval None
*/
